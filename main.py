...
class ModernTodo:
    def __init__(self, master):
        self.master = master
        self.master.title("Rorry's To-do List")
        ...
        self.add_button = ttk.Button(self.frame, text="Añadir Tarea", command=self.add_task)
        self.add_button.grid(row=0, column=1, padx=5, pady=10)

        self.task_tree = ttk.Treeview(self.frame, columns=("Tarea",), show="headings", height=15)
        self.task_tree.heading("Tarea", text="Tareas")
        ...
        self.delete_button = ttk.Button(self.frame, text="Elminar Tarea", command= self.delete_task)
        self.delete_button.grid(row=2, column=0, padx=5, pady=10, sticky="ew")

        self.save_button = ttk.Button(self.frame, text="Guardar Tarea", command=self.save_tasks)
    ...
    def add_task(self):
        ...
        if task:
            ...
            messagebox.showwarning("Warning","Porfavor ingrese una tarea.")
    ...
    def delete_task(self):
        ...
        if selected_item:
            ...
            messagebox.showwarning("Peligro","Porfavor selecciona una Tarea a eliminar.")
